...
public class ChatService {
    ...
    public Chat getEntityById(Long id) {
        ...
        return chatRepository.findById(id)
                .orElseThrow(()-> new ResourceNotFoundException("El Chat con id "+ id +" no fue encontrado"));
    ...
    public List<User> addUser(Long chatId,Long userId){
        ...
        Chat chat = chatRepository.findById(chatId)
                .orElseThrow(()-> new ResourceNotFoundException("El Chat con id "+ chatId +" no fue encontrado"));
